        ...
        <div className="hero-container">
          <div className="hero-left">
            ...
            <div className="infocenter relative">
              <h1 className="font-bold text-opacity-50 text-white font-sans text-2xl lg:text-[1.68rem] left-0">{date()}</h1>
              <h1 className="font-bold text-opacity-50 text-white font-sans text-9xl lg:text-[9rem] left-0">4:44</h1>
            </div>
            {/*bottom bar*/}
